    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <form  className={styles.form}>
                ...
                {errors.hasOwnProperty('name') || errors.hasOwnProperty('resume') || errors.hasOwnProperty('image') || errors.hasOwnProperty('healthScore')?  <p className={styles.adv}> Please complete all the inputs in order to create your recipe</p> : <button className={!ableToSubmit ? styles.buttonSubmit : styles.buttonDisabled} disabled={setAbleToSubmit} type='submit' onSubmit={(e) => {handleChange(e)}}> Create it</button>  }
